...
export function AuthModal() {
  ...
  return (
    <Modal
      ...
      label={mode === "login" ? "Вход в аккаунт" : "Регистрация"}
      className="max-w-[430px] rounded-[36px] sm:p-10"
    >
      ...
      <form onSubmit={submit} className="mt-8 space-y-4">
        ...
        {error && <p role="alert" className="rounded-2xl bg-danger/[.07] px-4 py-3 text-[13px] text-danger">{error}</p>}
